...
const AccountsPage = () => {
  ...
  const accoutsQuery = useGetAccounts();
  const deleteAccounts = useBulkDeleteAccount();
  const accounts = accoutsQuery.data || [];

  const isDisabled = accoutsQuery.isLoading || deleteAccounts.isPending;

  if (accoutsQuery.isLoading) {
    return (
